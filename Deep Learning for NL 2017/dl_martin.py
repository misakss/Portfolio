# -*- coding: utf-8 -*-
"""
Created on Sat Jan 28 16:00:48 2017
...
if __name__ == "__main__":
    ...
    model_PLSTM.add(PLSTM(128, consume_less='gpu', return_sequences=True))
    ...
    model_LSTM.add(LSTM(128, dropout_W=DROPOUT, dropout_U=DROPOUT, return_sequences=True))
