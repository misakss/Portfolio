...
figure
bode(Gtilde)
title('Minimum Phase - Gtilde Static Decoupling')
...
f1tilde=K1*(1+(1/(s*T1)));
f2tilde=K2*(1+(1/(s*T2)));
Ftilde=minreal(append(f1tilde,f2tilde));
...
% % % subplot(2,1,1)
% % % sigma(S)
% % % title('Minimum Phase - Static Decoupling - Singular values S')
% % % subplot(2,1,2)
% % % sigma(T)
% % % title('Minimum Phase - Static Decoupling - Singular values T')
% % % figure
% % % bode(G*F)
% % % title('Minimum Phase - Bode Static Decoupling')
...
% 3.2.1.
wc=0.1; % wc=0.02 rad/s for non-minimum phase
W1=[1 w21;w12 1]; % W1 can change depending on minimum phase or non-minimum phase (see RGA)
W1_proper=isproper(W1)
Gtilde=minreal(G*W1); % Want this to be diagonal
figure
bode(Gtilde)
title('Minimum Phase - Gtilde Dynamic Decoupling')
...
% % % subplot(2,1,1)
% % % sigma(S)
% % % title('Minimum Phase - Dynamical Decoupling - Singular values S')
% % % subplot(2,1,2)
% % % sigma(T)
% % % title('Minimum Phase - Dynamical Decoupling - Singular values T')
% % % figure
% % % bode(G*F)
% % % title('Minimum Phase - Bode Dynamical Decoupling')
...
% % % subplot(2,1,1)
% % % sigma(S)
% % % title('Minimum Phase - Glover-McFarlane for Dynamic Decoupling - Singular values S')
% % % subplot(2,1,2)
% % % sigma(T)
% % % title('Minimum Phase - Glover-McFarlane for Dynamic Decoupling - Singular values T')
