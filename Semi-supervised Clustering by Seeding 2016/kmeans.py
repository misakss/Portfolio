...
from amltlearn.datasets import make_blobs # Used for Dataset 2
from numpy.random import normal # Used for Dataset 3
...
X, y = make_blobs(n_samples=[100,75], n_features=2, centers=[[-1,1],[-0.2,-0.5]], cluster_std=[0.2,0.1])
dataSet=X
